...
selected_population <- CreateFlowChart(
  ...
  listcriteria = c("sex_or_birth_date_missing","birth_date_absurd","not_female","not_in_fertile_age_at_study_entry_date","insufficient_run_in","death_before_study_entry"),
